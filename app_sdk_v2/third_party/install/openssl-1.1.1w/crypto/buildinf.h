...
#define DATE "built on: Fri Apr 10 08:32:03 2026 UTC"
...
static const char compiler_flags[] = {
    ...
    'x','i','a','o','y','u','b','b','/','D','o','w','n','l','o','a',
    'd','s','/','t','o','o','l','c','h','a','i','n','-','s','u','n',
    'x','i','-','g','l','i','b','c','-','g','c','c','-','8','3','0',
    '/','t','o','o','l','c','h','a','i','n','/','b','i','n','/','a',
    'r','m','-','o','p','e','n','w','r','t','-','l','i','n','u','x',
    '-','g','n','u','e','a','b','i','-','g','c','c',' ','-','f','P',
