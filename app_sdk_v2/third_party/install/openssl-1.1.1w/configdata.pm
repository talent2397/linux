...
our %config = (
  ...
  CPPFLAGS => [  ],
  CPPINCLUDES => [  ],
  CROSS_COMPILE => "/home/xiaoyubb/Downloads/toolchain-sunxi-glibc-gcc-830/toolchain/bin/arm-openwrt-linux-gnueabi-",
  CXX => "g++",
  CXXFLAGS => [ "-Wall -O3" ],
  ...
  prefix => "/home/xiaoyubb/xiangmu/app_sdk_v2/third_party/install/openssl",
  processor => "",
