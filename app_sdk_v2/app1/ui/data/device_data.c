...
void init_device_state()
{
    ...
    device_state.ble_mesh_state = CONNECT;
...
void set_wifi_connect_state(int connected)
{
    if (connected)
    {
        device_state.wifi_connect_state = WPA_WIFI_CONNECT;
        printf("set_wifi_connect_state: WiFi已连接\n");
    }
    else
    {
        device_state.wifi_connect_state = WPA_WIFI_DISCONNECT;
        printf("set_wifi_connect_state: WiFi未连接\n");
    }
